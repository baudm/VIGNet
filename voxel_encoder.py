...
def create_3d_autoencoder():
    ...
    proc_inp = Preprocessor()(inp)

    conv1a = Conv2D(96, (7,7), strides=(1, 1), padding='same')(proc_inp)
    rect1a = Activation('relu')(conv1a)
    conv1b = Conv2D(96, (3,3), strides=(1, 1), padding='same')(rect1a)
    rect1 = Activation('relu')(conv1b)
    pool1 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(rect1)

    conv2a = Conv2D(128, (3,3), strides=(1, 1), padding='same')(pool1)
    rect2a = Activation('relu')(conv2a)
    conv2b = Conv2D(128, (3,3), strides=(1, 1), padding='same')(rect2a)
    rect2 = Activation('relu')(conv2b)
    conv2c = Conv2D(128, (1,1), strides=(1, 1), padding='same')(pool1)
    res2 = Add()([conv2c, rect2])
    pool2 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(res2)

    conv3a = Conv2D(256, (3,3), strides=(1, 1), padding='same')(pool2)
    rect3a = Activation('relu')(conv3a)
    conv3b = Conv2D(256, (3,3), strides=(1, 1), padding='same')(rect3a)
    rect3 = Activation('relu')(conv3b)
    conv3c = Conv2D(256, (1,1), strides=(1, 1), padding='same')(pool2)
    res3 = Add()([conv3c, rect3])
    pool3 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(res3)

    conv4a = Conv2D(256, (3,3), strides=(1, 1), padding='same')(pool3)
    rect4a = Activation('relu')(conv4a)
    conv4b = Conv2D(256, (3,3), strides=(1, 1), padding='same')(rect4a)
    rect4 = Activation('relu')(conv4b)
    pool4 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(rect4)

    conv5a = Conv2D(256, (3,3), strides=(1, 1), padding='same')(pool4)
    rect5a = Activation('relu')(conv5a)
    conv5b = Conv2D(256, (3,3), strides=(1, 1), padding='same')(rect5a)
    rect5 = Activation('relu')(conv5b)
    conv5c = Conv2D(256, (1,1), strides=(1, 1), padding='same')(pool4)
    res5 = Add()([conv5c, rect5])
    pool5 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(res5)

    conv6a = Conv2D(256, (3,3), strides=(1, 1), padding='same')(pool5)
    rect6a = Activation('relu')(conv6a)
    conv6b = Conv2D(256, (3,3), strides=(1, 1), padding='same')(rect6a)
    rect6 = Activation('relu')(conv6b)
    res6 = Add()([pool5, rect6])
    pool6 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(res6)

    flat6 = Flatten()(pool6)
    fc7 = Dense(1024)(flat6)
    rect7 = Activation('relu')(fc7)

    # Dummy 3D grid hidden representations
    prev_s = Reshape((2,2,2,128))(rect7)
    t_x_rs = Conv3D(128, (3,3,3), strides=(1,1,1), padding='same')(prev_s)

    ## DECODER
    unpool7 = UpSampling3D(size=(2,2,2))(t_x_rs)
    conv7a = Conv3D(128, (3,3,3), strides=(1,1,1), padding='same')(unpool7)
    rect7a = Activation('relu')(conv7a)
    conv7b = Conv3D(128, (3,3,3), strides=(1,1,1), padding='same')(rect7a)
    rect7 = Activation('relu')(conv7b)
    res7 = Add()([conv7a, rect7])

    unpool8 = UpSampling3D(size=(2,2,2))(res7)
    conv8a = Conv3D(128, (3,3,3), strides=(1,1,1), padding='same')(unpool8)
    rect8a = Activation('relu')(conv8a)
    conv8b = Conv3D(128, (3,3,3), strides=(1,1,1), padding='same')(rect8a)
    rect8 = Activation('relu')(conv8b)
    res8 = Add()([conv8a, rect8])

    unpool9 = UpSampling3D(size=(2,2,2))(res8)
    conv9a = Conv3D(64, (3,3,3), strides=(1,1,1), padding='same')(unpool9)
    rect9a = Activation('relu')(conv9a)
    conv9b = Conv3D(64, (3,3,3), strides=(1,1,1), padding='same')(rect9a)
    rect9 = Activation('relu')(conv9b)

    conv9c = Conv3D(64, (1,1,1), strides=(1,1,1), padding='same')(unpool9)
    res9 = Add()([conv9c, rect9])

    unpool10 = UpSampling3D(size=(2,2,2))(res9)
    conv10a = Conv3D(32, (3,3,3), strides=(1,1,1), padding='same')(unpool10)
    rect10a = Activation('relu')(conv10a)
    conv10b = Conv3D(32, (3,3,3), strides=(1,1,1), padding='same')(rect10a)
    rect10 = Activation('relu')(conv10b)

    conv10c = Conv3D(32, (3,3,3), strides=(1,1,1), padding='same')(rect10a)
    res10 = Add()([conv10c, rect10])

    conv11 = Conv3D(2, (3,3,3), strides=(1,1,1), padding='same')(res10)
